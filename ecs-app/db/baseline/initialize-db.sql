...
CREATE ROLE :databaseAppUser
    WITH LOGIN PASSWORD ':databaseAppUserPassword'
...
ALTER DEFAULT PRIVILEGES IN SCHEMA :databaseSchema
    GRANT INSERT, SELECT, UPDATE, DELETE, TRUNCATE, REFERENCES, TRIGGER ON TABLES TO :databaseAppRole; 

ALTER DEFAULT PRIVILEGES IN SCHEMA :databaseSchema
    GRANT SELECT, USAGE ON SEQUENCES TO :databaseAppRole; 

CREATE SCHEMA IF NOT EXISTS :liquibaseSchema AUTHORIZATION :databaseAdmin;